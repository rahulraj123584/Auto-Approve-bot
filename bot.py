...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_video(kk.id,img, "**Hello {}!\nWelcome To {}\n\n__Congrats!! We Have A VIP Channel For you Absolutely Free \n__Join Now @HunterWolves__**".format(m.from_user.mention, m.chat.title))
        add_user(kk.id)
    ...
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🗯 Channel", url="https://t.me/HunterWolves"),
                        InlineKeyboardButton("💬 Support", url="https://t.me/HunterWolves")
                    ],[
                        InlineKeyboardButton("➕ Add me to your Chat ➕", url="https://t.me/HunterWolves")
                    ]
                ]
            )
            add_user(m.from_user.id)
            await m.reply_photo("https://telegra.ph/file/a782e3bbbe40df8a4bb67.jpg", caption="**🦊 Hello {}!\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__Powerd By : @HunterWolves**".format(m.from_user.mention, "https://t.me/telegram/153"), reply_markup=keyboard)
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton("➕ Add me to your Chat ➕", url="https://t.me/FreeVipLeaksBot?startgroup")
                    ]
                ]
            )
